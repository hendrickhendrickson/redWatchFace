...
import { and, eq, group, gt, gte, lte, or, src, type Expr } from './expr.ts';
...
const SHIPPED: Array<[string, Expr, string]> = [
	...
	[
		'HIGH_UV',
		HIGH_UV,
		'[WEATHER.IS_AVAILABLE] &amp;&amp; [WEATHER.UV_INDEX] &gt;= 6 &amp;&amp; [WEATHER.IS_DAY]'
	],
	[
		'HOT_AND_SUNNY',
		HOT_AND_SUNNY,
 ...
 *
 * `T` is `as const`, so TypeScript knows the literal values and can decide these three

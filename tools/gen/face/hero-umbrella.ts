...
import {
  UMBRELLA, UMBRELLA_HOOK, UMBRELLA_LOBES, UMBRELLA_RIBS, UMBRELLA_SHAFT, UMBRELLA_SPAN,
  ...
  when('prop_wet', RAIN_LIKELY, [
    el('Group', { name: 'hero_umbrella', ...G.ANCHORS.HERO_UMBRELLA, alpha: 255 }, [
      ...
      el('PartDraw', { name: 'umbrella_shaft', ...G.at(164, 70) }, [
        ...UMBRELLA_SHAFT.map((s) => el('Line', { ...s }, bone(UMBRELLA.shaft.thickness))),
      ...
      el('PartDraw', { name: 'umbrella_canopy', ...G.at(164, 30) }, [
        ...
        ...UMBRELLA_LOBES.map((l) => el('Ellipse', { ...l }, [el('Fill', { color: C.TEAL })])),
        ...UMBRELLA_RIBS.map((s) =>
          el('Line', { ...s }, [

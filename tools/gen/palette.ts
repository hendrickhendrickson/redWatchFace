 ...
 */
export const dateChip = (body: Hex): Hex => fromHsl(toHsl(body).h, 0.20, 0.28)
...
export const SHIPPED = {
  mouth: {
    mon: '#5b2622', tue: '#594c1e', wed: '#3f4c24', thu: '#273f69',
    fri: '#57381f', sat: '#3a434d', sun: '#482e62',
  },
  chip: {
    mon: '#563b39', tue: '#564f39', wed: '#4d5639', thu: '#394456',
    fri: '#564639', sat: '#394656', sun: '#473956',
  },
  text: {
    mon: '#d3bcbb', tue: '#d3cebb', wed: '#cbd3bb', thu: '#bbc4d3',
    fri: '#d3c6bb', sat: '#bbc6d3', sun: '#c7bbd3',
  },
...
export function verifyDerivation(): string[] {
  ...
  for (const d of WEEKDAYS) {
    ...
    const checks: Array<[string, Hex, Hex]> = [
      [`mouth ${d}`, mouth(body), SHIPPED.mouth[d]],
      [`date chip ${d}`, dateChip(body), SHIPPED.chip[d]],
      [`date text ${d}`, dateText(body), SHIPPED.text[d]],
    ]

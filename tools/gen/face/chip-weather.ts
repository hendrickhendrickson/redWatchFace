					...
					switchOn(
						[
							{
								...
								then: [
									icon('wx_icon_rain', [
										el(
											'RoundRectangle',
											{ x: 3, y: 9, width: 20, height: 8, cornerRadiusX: 4, cornerRadiusY: 4 },
							...
							},
							{
								...
								then: [
									icon('wx_icon_partly', [
										...
										el(
											'RoundRectangle',
											{ x: 4, y: 15, width: 19, height: 8, cornerRadiusX: 4, cornerRadiusY: 4 },
											[el('Fill', { color: C.CLOUD })]
										),
							...
							},
							{
								...
								then: [
									icon('wx_icon_sun', [
										el('Ellipse', { ...SUN_DISC }, [el('Fill', { color: C.SUN })]),
										...SUN_RAYS.map((s) =>
											el('Line', { ...s }, [
						...
						[
							icon('wx_icon_cloud', [
								el(
									'RoundRectangle',
									{ x: 2, y: 13, width: 22, height: 9, cornerRadiusX: 4.5, cornerRadiusY: 4.5 },
									[el('Fill', { color: C.CLOUD })]
								),
